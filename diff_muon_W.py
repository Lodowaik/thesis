...
def main():
  ...
  histos["diff_muon_eta_W"] = TH1F("diff_muon_eta_W", "diff_muon_eta_W; diff_muon_eta_W; entries", 100, -1, 1)
  histos["diff_muon_phi_W"] = TH1F("diff_muon_phi_W", "diff_muon_phi_W; diff_muon_phi_W; entries", 100, -1, 1)
